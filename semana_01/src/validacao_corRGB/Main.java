...
public class Main {
	...
	public static void main(String[] args) {
		/*
		 * Faça um programa que receba três valores inteiros representando os valores de **R**, **G** e **B**. O programa deve verificar se esses valores formam uma cor válida no sistema RGB. As regras são:
		 * - Cada valor deve estar entre 0 e 255.
		 * Se válido, exiba "Cor válida". Caso contrário, exiba "Cor inválida".
		 */
