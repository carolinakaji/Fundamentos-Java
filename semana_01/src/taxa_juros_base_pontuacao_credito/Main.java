...
public class Main {
	...
	public static void main(String[] args) {
		/*
		 * **Determinação de Taxa de Juros com Base na Pontuação de Crédito**
		 * Implemente um programa que calcule a taxa de juros com base na pontuação de crédito:
		 * - Pontuação >= 800: Taxa de juros 1.5%
		 * - Pontuação >= 700 e < 800: Taxa de juros 2.0%
		 * - Pontuação >= 600 e < 700: Taxa de juros 3.5%
		 * - Pontuação < 600: Empréstimo negado.
		 */
